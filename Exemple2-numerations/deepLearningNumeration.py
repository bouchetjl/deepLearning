...
lesnumerations_norm = normalize(lesnumerations)

X_numerations = lesnumerations_norm[
    ['Hematies', 'Leucocytes', 'Hemoglobine', 'Sexe']]


lesnumerations_norm['NotAlerte'] = 1 - lesnumerations_norm['Alerte']
y_numerations = lesnumerations_norm[['Alerte', 'NotAlerte']]
...
#    'h1': tf.Variable(tf.random_uniform(shape=(n_input, n_hidden_1),minval=-5, maxval=5, dtype=tf.float32, seed=0)),
    ...
    'h2': tf.Variable(tf.random_uniform(shape=(n_hidden_1, n_hidden_2),minval=-1, maxval=1, dtype=tf.float32, seed=0)),
